...
void Warrior::PrintResult(int nTime)
{
    ...
    switch (kindNo) {
        case 0:{
            float morale = pHeadquarter->totalLifeValue / (float) initialLifeValue[kindNo];
            cout << "It has a " << arms[no % 3] <<",and it's morale is ";
            printf("%.2f\n", morale);
            break;
        }
        ...
        case 1:{
            int arm1 = no % 3;
            int arm2 = (no + 1) % 3;
            cout << "It has a " << arms[arm1] <<" and a " << arms[arm2] <<endl;
            break;
        }
            
        case 2:{
            cout <<"It has a " << arms[ no % 3]<<endl;
            
            break;
        }
            
        case 3:{
            int loyality = pHeadquarter->totalLifeValue;
            cout << "It's loyalty is " <<loyality<<endl;
            break;
        }
...
string Warrior::names[WARRIOR_NUM] = { "dragon","ninja","iceman","lion","wolf" };
string Warrior::arms[3] = {"sword", "bomb", "arrow"};
